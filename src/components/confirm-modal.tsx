    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/20 z-[100]">
      <div className="bg-white rounded-xl shadow-xl w-[442px] h-[343px] text-center relative p-6 flex flex-col justify-between">
        ...
        <div className="flex justify-center gap-6 mb-4">
          <button
            onClick={onCancelAction}
            className="px-8 py-2 rounded-sm border-2 border-gray-700 text-gray-800 font-bold hover:bg-gray-100 text-lg"
          >
            Cancel
          </button>
          <button
            onClick={onConfirmAction}
            className={`px-8 py-2 rounded-md text-white text-lg ${buttonColorClass}`}
          >
            {buttonLabel}
          </button>
        </div>

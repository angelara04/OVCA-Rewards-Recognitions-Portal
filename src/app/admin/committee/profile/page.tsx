...
export default function CommitteeProfilePage() {
  ...
  // Helper to format date on client
    ...
    <Section>
      <div className="w-full max-w-5xl text-sm">
        ...
        <div className="mb-8 border-b border-gray-100 pb-6">
          <h1 className="text-2xl sm:text-[28px] font-bold text-gray-900">
            Profile Information
          </h1>
        ...
        <div className="flex flex-col md:flex-row gap-12 w-full">
          ...
          <div className="flex flex-col items-center md:w-1/3 w-full">
            <div className="relative mb-4">
              ...
              <div className="absolute bottom-2 right-2 sm:bottom-3 sm:right-3 bg-red-900 rounded-full p-2 text-white border-2 border-white">
                <User size={16} />
              </div>
            </div>
          ...
          <div className="flex flex-col flex-1 w-full space-y-10">
            ...
            <div className="w-full">
              <h3 className="font-bold text-lg mb-4 text-red-900 border-l-4 border-red-900 pl-3">
                Personal Information
              </h3>
              <div className="flex flex-col gap-4">
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 border-b border-gray-100 py-4">
                  <div className="bg-red-50 p-2 rounded text-red-900 shrink-0"><User size={24} /></div>
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 border-b border-gray-100 py-4">
                  <div className="bg-red-50 p-2 rounded text-red-900 shrink-0"><Mail size={24} /></div>
                  <div className="flex flex-col sm:flex-row sm:items-center w-full justify-between">
            ...
            <div className="w-full">
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 border-b border-gray-100 py-4">
                  <div className="bg-red-50 p-2 rounded text-red-900 shrink-0"><Briefcase size={24} /></div>
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 border-b border-gray-100 py-4">
                  <div className="bg-red-50 p-2 rounded text-red-900 shrink-0"><Calendar size={24} /></div>
                  <div className="flex flex-col sm:flex-row sm:items-center w-full justify-between">
        ...
        {/* --- ACCOUNT ACTIVITY (Fixed Stats Access) --- */}
        <div className="mt-12">
          <h3 className="font-bold text-lg mb-6 text-red-900 border-l-4 border-red-900 pl-3">
            Account Activity
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="border border-gray-200 rounded-xl p-6 bg-white shadow-sm hover:shadow-md transition-shadow">
              <p className="text-gray-500 text-sm mb-1">Reviews Completed</p>
              {/* 🔥 FIX: Use profile.stats.reviewsCompleted */}
              <p className="font-bold text-gray-900 text-lg mb-1">{profile.stats.reviewsCompleted}</p>
              <p className="text-xs text-gray-400">Total reviews completed</p>
            </div>

            <div className="border border-gray-200 rounded-xl p-6 bg-white shadow-sm hover:shadow-md transition-shadow">
              <p className="text-gray-500 text-sm mb-1">Pending Actions</p>
              {/* 🔥 FIX: Use profile.stats.reviewsPending */}
              <p className="font-bold text-gray-900 text-lg mb-1">{profile.stats.reviewsPending}</p>
